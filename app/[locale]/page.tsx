...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className={`w-full h-fit max-w-[350px] md:max-w-[720px] xl:max-w-[1200px] mx-auto my-[1.5rem] px-3 py-[2rem] overflow-hidden ${locale === 'km' ? 'font-krasar' : 'font-gotham'}`}>
        <div className="grid grid-flow-col grid-rows-3 xl:grid-rows-2 gap-5 w-full h-full overflow-hidden">
          <div className="w-full h-full flex flex-col md:flex-row row-span-1 xl:col-span-2">
            <Image
              data-aos="fade-right"
              data-aos-offset="500"
              data-aos-duration={`500`}
          ...
          <div className="w-full md:h-[30vh] xl:h-full row-span-1 xl:row-span-2 flex flex-col md:flex-row xl:flex-col">
            <Image
              data-aos="fade-down"
              data-aos-offset="500"
              data-aos-duration={`500`}
