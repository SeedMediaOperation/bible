...
import { formatOnlySplit } from '@/utils/formatSplit';
        ...
        <div className="relative flex flex-col justify-center w-full h-full overflow-hidden px-3 py-[5rem] md:py-[14rem] xl:py-[15rem] z-1">
          ...
          <div className="relative flex items-center">
              <div data-aos="fade-left"
                ...
                <span className="text-[14px] md:text-[22px] text-[#4FC9EE] font-light ">Catalogue</span>
                <h1 className="text-[40px] leading-[40px] md:text-[50px] md:leading-[50px] lg:text-[60px] lg:leading-[60px] font-bold text-wrap text-[#ffffff] capitalize">
                  {formatOnlySplit(params?.slug ?? '')}
                </h1>
              </div>
          </div>
        </div>
